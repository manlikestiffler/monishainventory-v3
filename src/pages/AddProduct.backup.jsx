...
const AddProduct = () => {
  ...
  const handleAddNewSchool = async () => {
    ...
    try {
      ...
      setSchools(prev => [...prev, { id: schoolRef.id, name: newSchoolName.trim() }]);
      setUniformData(prev => ({ ...prev, school: schoolRef.id }));
      setNewSchoolName('');
  ...
  const handleAddNewSize = async (newSize) => {
    SIZES.push(newSize);
    handleSizeChange(selectedVariantIndex, 0, 'size', newSize);
  };
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="block w-full h-12 rounded-xl border-gray-200 shadow-sm focus:ring-2 focus:ring-red-500/20 focus:border-red-500 text-base transition-shadow duration-200"
                        placeholder={`Enter quantity in ${rawMaterialData.unit.toLowerCase()}`}
                        min="0"
                        required
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <div
                          className="h-12 w-12 rounded-xl border border-gray-200 cursor-pointer shadow-sm hover:shadow transition-shadow duration-200"
                          style={{ backgroundColor: rawMaterialData.color }}
                          ...
                          <div className="absolute z-10 mt-2">
                            ...
                            <div className="relative">
                              <HexColorPicker
                                ...
                                onChange={(color) => handleRawMaterialChange('color', color)}
                              />
                            </div>
                          </div>
                        )}
                  ...
                  <div className="grid grid-cols-1 gap-8">
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={(e) => handleRawMaterialChange('description', e.target.value)}
